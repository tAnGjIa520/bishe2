...
gps=3
blocks=19
img_dir=abs+opt.test_imgs+os.sep
output_dir=abs+f'pred_FFA_{dataset}'+os.sep
print("pred_dir:",output_dir)
if not os.path.exists(output_dir):
    os.mkdir(output_dir)
model_dir=abs+f'trained_models'+os.sep+f'{dataset}_train_ffa_{gps}_{blocks}.pk'
...
for im in os.listdir(img_dir):
    ...
    print(output_dir+im.split('.')[0]+'_FFA.png')
